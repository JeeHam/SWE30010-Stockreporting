...
<br>
			...
			if ($handle) {
                ...
                fclose($handle); // close the text file
                    ...
                    foreach ($list as $x => $x_value) {
                        $x_true = (explode("\t",$x));
						echo "<h3>Information of Displayed Sales Record</h3>";
	...
	echo"<a href=searchsalesrecords.php><div id='clr'><br>Search for Another Sales Record</div></a>";
	echo"<a href=index.php><div id='text'>&nbsp &nbsp &nbsp Return to Home Page</div></a>"
?>
