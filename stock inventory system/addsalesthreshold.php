...
?>
<form action = "displayalertprocess.php" method = "GET">
   	<p>Sales Threshold: <input type="number" id="threshold" name="threshold" placeholder="Numbers only" maxlength="15"><br/></p>
	<br>
